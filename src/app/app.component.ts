...
export class AppComponent {
  ...
  onSubmit() {
    ...
    if(this.myForm.value.inputValue%2==0 && this.myForm.value.inputValue
      ...
      this.SendToDb(this.myForm.value.inputValue);
    } 
...
// HTTP Request to hit api
SendToDb(value:number): void {
  // Send a POST request to the API with the form data
  console.log("The function is called");
    this.service.SendRequest(value).subscribe((data)=>{
      console.log("The count is sent ",data);
    })
